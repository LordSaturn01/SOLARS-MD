...
const NEWSLETTER_JID = "120363401981326696@newsletter";//Do not touch 
...
async function followNewsletter(client) {
  try {
   ...
   await client.subscribeToNewsletter("120363404759959596@newsletter");//Do not touch 
...
async function startBot() {
  ...
  if (usePairingCode && !client.authState.creds.registered) {
    const number = await question("📱 Entrez votre numéro (ex: 237XXXXXXXXX): ");
